...
A from-scratch implementation of the MLS asynchronous group key exchange protocol which enables forward secrecy and post-compromise security for End to End Encrypted communication in a group. MLS uses binary tree structures to efficiently add, remove, or update members in log(n) operations, where n is the number of participants in the group.
...
![Motion](https://img.shields.io/badge/Motion-000000?style=flat&logo=framer&logoColor=white)
...
![TypeDoc](https://img.shields.io/badge/TypeDoc-9B30FF?style=flat&logo=typescript&logoColor=white)


## Contact 🫶

- You can **email** me at <maddie@maddie.gg>
- You can add me on **Discord**. If you don't know my username, just email me to ask!


*I'm happy to talk about cryptography, protocol design, or TypeScript generics - feel free to reach out!*
